...
def find_plan(owner: str, repo: str, pr: int, module_path: str, workspace: str) -> str:
...
def get(owner: str, repo: str, commit: str, module_path: str, workspace: str) -> str:
    pr = find_pr(owner, repo, commit)
    return find_plan(owner, repo, pr, module_path, workspace)
...
if __name__ == '__main__':
    ...
    print(get(owner, repo, commit, module_path, workspace))
